...
for mm = 1:length(rates)
    clearvars -except rates mm k maxpoints model mod_full
    ...
    p2 = plot(0:length(h12)-1,h12,'-go','LineWidth',2);
    ...
    sgtitle({[mod_full,' vs Permutations (n=500)'];'Spike-Spike';['rate = ',num2str(rates(mm)),' Hz']});
